...
#             score = 0.3 + (pattern_matches * 0.25)
...
#                 sarcasm_prob = max(label_probs[target_label], self._heuristic_score(text))
...
#         # Get fuzzy degree
#         p_sarcastic = prediction.get("p_light_hearted", 0.0) + prediction.get("p_heavy_hearted", 0.0) \
#                       if "p_light_hearted" in prediction else prediction.get("sarcasm_score", 0.0)
